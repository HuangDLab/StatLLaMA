'''
python SFT_v3.4_DPO_DTFT_v1.py
'''
...
wandb.init(project="statistical-llm-sft", name="SFT_v3.4_DPO_DTFT_v1")
...
model = FastLanguageModel.get_peft_model(
    ...
    bias="none", # Typically set to 'none' or 'all'
)
...
training_args = TrainingArguments(
    ...
    weight_decay=0.01, 
    seed=SEED,
    output_dir="SFT_v3.4_DPO_DTFT_v1",
    report_to="wandb", 
    run_name="SFT_v3.4_DPO_DTFT_v1",
    save_strategy="epoch",
)
...
model_location = "SFT_v3.4_DPO_DTFT_v1"
