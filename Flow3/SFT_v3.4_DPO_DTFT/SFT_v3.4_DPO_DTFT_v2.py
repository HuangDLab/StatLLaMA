'''
python SFT_v3.4_DPO_DTFT_v2.py
'''
...
wandb.init(project="statistical-llm-sft", name="SFT_stat_v1_4_DPO_Final")
...
training_args = TrainingArguments(
    ...
    weight_decay=0.01, 
    seed=SEED,
    output_dir="SFT_DPO_Final2",
    report_to="wandb", 
    run_name="SFT_DPO_Final2",
    save_strategy="epoch",
)
...
model_location = "SFT_v3.4_DPO_DTFT_v2"
