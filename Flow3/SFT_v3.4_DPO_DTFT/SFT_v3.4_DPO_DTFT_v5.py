'''
python SFT_v3.4_DPO_DTFT_v5.py
'''
...
wandb.init(project="statistical-llm-sft", name="SFT_v3.4_DPO_DTFT_v5")
...
training_args = TrainingArguments(
    ...
    weight_decay=0.01, 
    seed=SEED,
    output_dir="SFT_v3.4_DPO_DTFT_v5",
    report_to="wandb", 
    run_name="SFT_v3.4_DPO_DTFT_v5",
    save_strategy="epoch",
)
...
model_location = "SFT_v3.4_DPO_DTFT_v5"
