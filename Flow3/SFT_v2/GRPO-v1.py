...
dataset2 = dataset2.select(range(4000))
...
max_prompt_length = 1024 # Increased slightly, adjust based on typical question length
...
training_args = GRPOConfig(
    ...
    num_generations = 6, # User had 6. Reduce if OOM. More generations = better preference signal but slower/more memory.
